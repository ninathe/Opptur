            ...
            link: function(scope, element, attrs, model) {
                ...
                google.maps.event.addListener(scope.gPlace, 'place_changed', function() {
                    scope.$apply(function() {
                        ...
                        var latitude = scope.gPlace.gm_accessors_.place.zc.place.geometry.location.lat();
                        var longitude = scope.gPlace.gm_accessors_.place.zc.place.geometry.location.lng();
